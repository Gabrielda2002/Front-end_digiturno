...
const Dashboard = () => {
  ...
  const { historialTurnos: turnos, fetchActiveTurnos:fetchTurnosPendientes } = useTurnoStore();
            ...
            {isLoading ? (
              ...
              <div className="space-y-4">
                {turnos?.length > 0 ? (
                  ...
                  <p className="text-gray-500 text-center py-4">No hay turnos en espera</p>
                )}
              </div>
            )}
          </Card>
          ...
          <Card>
            ...
            <div className="text-center py-8">
              ...
              <div className="mt-4 space-y-2">
                <Button variant="success" fullWidth>Atendido</Button>
                <Button variant="danger" fullWidth>Ausente</Button>
                <Button variant="danger" fullWidth>Reasignar</Button>
              </div>
            </div>
          </Card>
        </div>
